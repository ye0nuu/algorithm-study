...
# ✅ 내 풀이 아이디어:
# - enter 후 채팅을 입력한 사람을 중복없이 저장할 greet set를 만든다.
# - N줄 만큼 반복하며 문자열을 입력받고, ENTER일 경우 그동안 저장된 집합의 길이를 count에 더하고 집합을 비운다.
# - ENTER가 아니면 문자열을 greet에 추가한다.
# - 반복문을 빠져나오면 마지막 greet 길이를 count에 더하고 출력한다. 
